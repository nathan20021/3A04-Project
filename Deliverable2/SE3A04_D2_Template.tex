...
% DataControllerClass
	...
	\hline 
	Handle request to save unencrypted Taxi Session Data from TaxiSessionController for authenticated users & TaxiSessionController, DataEncryptionController\\ \hline 
	Handle request to fetch, and save unencrypted Authetication Data from AuthenticationController &AuthenticationController, DataEncryptionController\\ \hline 
	Handle request to fetch unencrypted Prompt Data from PromptController for authenticated users &PromptController, DataEncryptionController\\ \hline 
	Handle request to fetch, edit, and save unencrypted CarPool Data from Dispatcher for authenticated users &Dispatcher, DataEncryptionController\\ \hline 
	Handle request to fetch, edit, and save unencrypted User Setting Data from SettingController for authenticated users&SettingController, DataEncryptionController\\ \hline 
	Handle request to fetch, edit, and save unencrypted User Indentity Data from RegistrationController for authenticated users &RegistrationController, DataEncryptionController\\ \hline 
	Handle decrypted data returned from DataEncryptionController & DataEncryptionController\\ \hline 
